...
<p align="center">
  <img src="https://readme-typing-svg.herokuapp.com?font=Orbitron&size=26&duration=3000&color=00C2FF&center=true&vCenter=true&width=750&lines=INFOMAP+AIRBOX+CONTROL+CENTER+PRO;Monitoring+Système+Windows+en+Temps+Réel;Optimisation+%7C+Réseau+%7C+Performance;Solution+Desktop+Professionnelle" />
</p>
...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Type-Desktop%20Application-blue"/>
  <img src="https://img.shields.io/badge/Tech-Python%20%7C%20Tkinter%20%7C%20PSUTIL-green"/>
  <img src="https://img.shields.io/badge/Plateforme-Windows-lightgrey"/>
  <img src="https://img.shields.io/badge/Mode-Pro%20Monitoring-purple"/>
</p>
...
![01](screenshots/01-admin-mode-required.png)

### 📡 Absence de WiFi détectée
![02](screenshots/02-no-wifi-detected.png)

### 🔑 Licence non détectée
![03](screenshots/03-license-not-detected.png)

### 🧾 Activation licence
![04](screenshots/04-license-activation-window.png)

### ❌ Licence invalide
![05](screenshots/05-invalid-license-key.png)

### 📊 Dashboard (chargement hors ligne)
![06](screenshots/06-dashboard-loading-offline.png)

### 📊 Dashboard offline
![07](screenshots/07-dashboard-offline-status.png)

### 🌐 Dashboard en ligne
![08](screenshots/08-dashboard-loading-online.png)

### 📈 Dashboard actif
![09](screenshots/09-dashboard-online-status.png)

### ⚡ Mode ECO confirmé
![10](screenshots/10-economy-mode-confirmation.png)

### ℹ️ À propos du système
![11](screenshots/11-about-window.png)
